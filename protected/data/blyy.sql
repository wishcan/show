...
CREATE TABLE IF NOT EXISTS `bl_advert` (
  ...
  `webid` varchar(45) DEFAULT NULL COMMENT '属于哪个页面',
  `position` varchar(45) DEFAULT NULL COMMENT '位置',
  `bl_web_wid` int(11) NOT NULL,
  `bl_position_pid` int(11) NOT NULL,
  PRIMARY KEY (`aid`,`bl_position_pid`),
  KEY `fk_bl_advert_bl_web1_idx` (`bl_web_wid`),
  KEY `fk_bl_advert_bl_position1_idx` (`bl_position_pid`)
...
CREATE TABLE IF NOT EXISTS `bl_gallery` (
  ...
  PRIMARY KEY (`gid`,`cid`),
  KEY `fk_bl_gallery_ bl_gallery_category1_idx` (`cid`)
...
(3, 1, 'adasdas', '', '0000-00-00 00:00:00', '', 1, 0, NULL, '', NULL, NULL, 0, 0, 0),
(4, 1, '测试', '', '0000-00-00 00:00:00', '', 1, 0, NULL, '', NULL, NULL, 0, 0, 0),
...
CREATE TABLE IF NOT EXISTS `bl_web` (
